    ...
    <div class="row">
                         ...
                         <li class="accordion">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                 <li class="accordion">
		                            ...
		                            <ul class="nav nav-pills nav-stacked">
		                                <li><a href="userp/pList_tionList"><i class="glyphicon glyphicon-eye-open"></i>人口信息查询</a></li>
		                                <li><a href="userp/pAdd_userAdd"><i class="glyphicon glyphicon-edit"></i>人口信息管理</a></li>
		                            </ul>
		                        </li>
                                ...
                                <li class="accordion">
		                            ...
		                            <ul class="nav nav-pills nav-stacked">
		                                <li><a href="p/pList_List"><i class="glyphicon glyphicon-eye-open"></i>车辆信息查询</a></li>
		                        ...
		                        <li class="accordion">
		                            ...
		                            <ul class="nav nav-pills nav-stacked">
		                                <li><a href="p/pList_List"><i class="glyphicon glyphicon-eye-open"></i>房屋信息查询</a></li>
		...
		<div class="row">
			<div class="box col-md-12">
				<form action="userp/pAddData_userPopulationList" class="form-horizontal" method="post" role="form">
