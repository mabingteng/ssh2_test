                         ...
                         <li class="accordion">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                 <li class="accordion">
		                            ...
		                            <ul class="nav nav-pills nav-stacked">
		                                <li><a href="userp/pList_userPopulationList"><i class="glyphicon glyphicon-eye-open"></i>人口信息查询</a></li>
		                                <li><a href="userp/pAdd_userPopulationAdd"><i class="glyphicon glyphicon-edit"></i>人口信息管理</a></li>
		                            </ul>
		                        </li>
					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-user"></i>  人口综合查询
								</h2>
										 ...
										 <%
											...
											<tr>
												...
												<td class="center"><a class="btn btn-success" href="#">
														...
														class="glyphicon glyphicon-edit icon-white"></i> Edit
												</a> <a class="btn btn-danger" href="p/pDel_populationList?population.id=<%= p.getId() %>"> <i
														class="glyphicon glyphicon-trash icon-white"></i> Delete
												</a></td>
											</tr>
										<%	
